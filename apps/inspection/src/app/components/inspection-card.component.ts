...
@Component({
  ...
  styles: [`
    .inspection-card {
      ...
      box-shadow: 0 2px 8px var(--card-shadow, rgba(0,0,0,0.08)); cursor: pointer;
      transition: all 200ms;
    }
    .inspection-card:hover { box-shadow: 0 4px 16px var(--card-shadow-hover, rgba(0,0,0,0.12)); transform: translateY(-2px); }
    .card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; gap: 0.5rem; }
    .card-id { font-size: 0.75rem; color: var(--text-tertiary, #6b7280); font-weight: 500; }
    ...
    .card-title { font-size: 1rem; font-weight: 600; color: var(--text-primary, #1f2937); margin: 0 0 0.5rem 0; }
    .card-location { font-size: 0.875rem; color: var(--text-tertiary, #6b7280); margin: 0 0 1rem 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .card-footer { display: flex; justify-content: space-between; align-items: center; gap: 0.5rem; flex-wrap: wrap; }
    .inspector { font-size: 0.875rem; color: var(--text-secondary, #4b5563); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
